...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 pull-right collapse navbar-collapse" id="bs-example-navbar-collapse-1">
...
<section id="services">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center sc-content">
        ...
        <div class="row text-center">
            <div class="col-md-4">
                <div class="sc-content services">
                    <img src="img/icons/icon-shopping-cart.png" alt="Shopping Cart Icon">
                    <h4>E-Commerce</h4>
...
-->
                <div class="sc-content services">
                    <img src="img/icons/icon-laptop.png" alt="Laptop Icon">
            ...
            <div class="col-md-4">
                <div class="sc-content services">
                    <img src="img/icons/icon-lock.png" alt="Lock Icon">
                    <h4>Web Security</h4>
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam
                        architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                    ...
                    <div class="sc-content portfolio-image">
                        <img class="img-responsive" src="img/portfolio/roundicons.png" alt="">
                    </div>
                </a>
                <div class="sc-content portfolio-caption">
                    <h4>Round Icons</h4>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                    ...
                    <div class="sc-content portfolio-image">
                        <img class="img-responsive" src="img/portfolio/startup-framework.png" alt="">
                    </div>
                </a>
                <div class="portfolio-caption sc-content">
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                    ...
                    <div class="sc-content portfolio-image">
                        <img class="img-responsive" src="img/portfolio/treehouse.png" alt="">
                    </div>
                </a>
                <div class="portfolio-caption sc-content">
                    <h4>Treehouse</h4>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                    ...
                    <div class="sc-content portfolio-image">
                        <img class="img-responsive" src="img/portfolio/golden.png" alt="">
                    </div>
                </a>
                <div class="portfolio-caption sc-content">
                    <h4>Golden</h4>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                    ...
                    <div class="sc-content portfolio-image">
                        <img class="img-responsive" src="img/portfolio/escape.png" alt="">
                    </div>
                </a>
                <div class="portfolio-caption sc-content">
                    <h4>Escape</h4>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                    ...
                    <div class="sc-content portfolio-image">
                        <img class="img-responsive" src="img/portfolio/dreams.png" alt="">
                    </div>
                </a>
                <div class="portfolio-caption sc-content">
                    <h4>Dreams</h4>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="timeline">
                    <li>
                        <div class="sc-content timeline-image">
                            <img class="img-circle" src="img/about/1.jpg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading sc-content">
                                <h4>2009-2011</h4>
                                <h4 class="subheading">Our Humble Beginnings</h4>
                            </div>
                            <div class="sc-content timeline-body">
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image sc-content">
                            <img class="img-circle" src="img/about/2.jpg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading sc-content">
                                <h4>March 2011</h4>
                    ...
                    <li>
                        <div class="timeline-image sc-content">
                            <img class="img-circle" src="img/about/3.jpg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="sc-content timeline-heading">
                                <h4>December 2012</h4>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image sc-content">
                            <img class="img-circle" src="img/about/4.jpg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="sc-content timeline-heading">
                                <h4>July 2014</h4>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image sc-content">
                            <img class="img-circle" src="img/about/5.jpg" alt="">
                        </div>
                    </li>
                </ul>
            </div>
...
<section id="team" class="bg-light-gray">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="sc-content team-member">

                    <img class="img-circle-boreder" src="img/team/1.jpg" alt="">

                    <h4>Kay Garland</h4>
                    <p class="text-muted">Lead Designer</p>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-instagram.png"></a>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-google.png"></a>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-pinterest.png"></a>
            ...
            <div class="col-sm-4">
                <div class="sc-content team-member">
                    ...
                    <img class="img-circle-boreder" src="img/team/2.jpg" alt="">
                    ...
                    <a target="_blank" href="#"><img src="img/icons/soc-ico-twitter.png"></a>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-facebook.png"></a>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-linkedin.png"></a>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="sc-content team-member">
                    <img class="img-circle-boreder" src="img/team/3.jpg" alt="">
                    <h4>Diana Pertersen</h4>
                    <p class="text-muted">Lead Developer</p>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-github.png"></a>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-youtube.png"></a>

                    <a target="_blank" href="#"><img src="img/icons/soc-ico-vk.png"></a>
                </div>
            </div>

        </div>
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center sc-content large">
                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut eaque, laboriosam
...
<div class="container clients">
    <div class="row">
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 sc-content">
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 sc-content">
            <img class="img-responsive" src="img/logos/envato.jpg" alt="">
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 sc-content">
            <img class="img-responsive" src="img/logos/designmodo.jpg" alt="">
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 sc-content">
            <img class="img-responsive" src="img/logos/themeforest.jpg" alt="">
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 sc-content">
            <img class="img-responsive" src="img/logos/creative-market.jpg" alt="">
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 sc-content">
        </div>
    </div>
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 sc-content quicklinks">
                <ul>
...
<a href="#page-top" class="page-scroll static">></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body sc-content-modal1">
                        <!-- Project Details Go Here -->
                        <h2>Project Name</h2>
                        <p class="intro-text">Lorem ipsum dolor sit amet consectetur.</p>
                        <img src="img/portfolio/roundicons-free.png" alt="">
                    ...
                    <a type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close
                        Project</a>
                </div>
            </div>
        </div>
...
<div class="portfolio-modal modal fade" id="portfolioModal2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body sc-content-modal2">
...
<div class="portfolio-modal modal fade" id="portfolioModal3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body sc-content-modal3">
                        <!-- Project Details Go Here -->
                        <h2>Project Name</h2>
                        <p class="intro-text">Lorem ipsum dolor sit amet consectetur.</p>
                        <img src="img/portfolio/treehouse-preview.png" alt="">
...
<div class="portfolio-modal modal fade" id="portfolioModal4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body sc-content-modal4">
                        <!-- Project Details Go Here -->
                        <h2>Project Name</h2>
                        <p class="intro-text">Lorem ipsum dolor sit amet consectetur.</p>
                        <img src="img/portfolio/golden-preview.png" alt="">
...
<div class="portfolio-modal modal fade" id="portfolioModal5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body sc-content-modal5">
                        <!-- Project Details Go Here -->
                        <h2>Project Name</h2>
                        <p class="intro-text">Lorem ipsum dolor sit amet consectetur.</p>
                        <img src="img/portfolio/escape-preview.png" alt="">
...
<div class="portfolio-modal modal fade" id="portfolioModal6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body sc-content-modal6">
                        <!-- Project Details Go Here -->
                        <h2>Project Name</h2>
                        <p class="intro-text">Lorem ipsum dolor sit amet consectetur.</p>
                        <img src="img/portfolio/dreams-preview.png" alt="">
